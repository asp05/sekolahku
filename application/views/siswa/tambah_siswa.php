      ...
      <div class="row">
        <section class="col-lg-9 col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" enctype="multipart/form-data" action="<?=base_url('master/siswa/tambah')?>">
              	<div class="row">
              	...
              	<div class="row">
              		<div class="col-lg-6 col-xs-12">
              			<div class="form-group">
              				...
              				<input type="text" name="masuk" value="<?=date('d-mY')?>" readonly class="form-control">
              			</div>
              		</div>
              		<div class="col-lg-6 col-xs-12">
              			<div class="form-group">
              				...
              				<input type="radio" name="jk" style="margin-left: 20px" value="perempuan" >Perempuan
              			</div>
              		</div>	
              	</div>
              	<div class="row">
              		<div class="col-lg-6 col-xs-12">
              			<div class="form-group">
              				...
              				<input type="number" name="tahun_mulai" value="20" class="form-control hitung" id="awal" value="<?=set_value('tahun_mulai')?>">
              		...
              		<div class="col-lg-6 col-xs-12">
              			<div class="form-group">
              				...
              				<input type="number" name="tahun_selesai" class="form-control hitung" id="akhir" readonly value="<?=set_value('tahun_selesai')?>">
              			</div>
              		</div>
              	</div>
              	<div class="row">
